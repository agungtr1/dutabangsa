                            ...
                            @foreach($datapeserta as $dp)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {!! Form::open(['url'=>route('datapeserta.destroy',$dp->id),'method'=>'delete','class'=>'form-inline js-confirm','data-confirm'=>'Are you sure you want to delete this item?','_token'=>csrf_token()]) !!}
