        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                    {!! Form::open(['url'=>route('export.datapesertaall.post'),'method'=>'post','class'=>'form-horizontal','role'=>'form','id'=>'filter-form']) !!}    
                        <div class="col-md-8">
                        ...
                        <!-- <div class="col-md-2">
                            <a class="btn btn-info" href="{{ route('export.datapesertaall.post') }}"><i class="fa fa-btn fa-print"></i> Export Semua Data</a>
                        </div> -->
                    {!! Form::close() !!}
                    </div>
                    <div class="row">
                    ...
                    {!! Form::open(['url' => route('export.datapeserta.post'),'method' => 'post', 'class'=>'form-horizontal']) !!}
                    <div class="form-group {!! $errors->has('id') ? 'has-error' : '' !!}">
                        {!! Form::label('id', 'Peserta', ['class'=>'col-md-2 control-label']) !!}
                        <div class="col-md-4">
                        {!! Form::select('id[]', [''=>'']+App\Peserta::pluck('nama','id')->all(),null, ['class'=>'js-selectize','multiple','placeholder' => 'Pilih Nama Peserta']) !!}
