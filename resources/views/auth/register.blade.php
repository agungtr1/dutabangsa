            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group{{ $errors->has('hakakses') ? ' has-error' : '' }}">
                        {!! Form::label('hakakses', 'Hak Akses', ['class'=>'col-md-4 control-label']) !!}
                        <div class="col-md-6">
                            {!! Form::select('hakakses', ['admin'=>'Admin','user'=>'User / Non Admin'], null, ['class'=>'form-control','placeholder' => 'Please Choose']) !!}
